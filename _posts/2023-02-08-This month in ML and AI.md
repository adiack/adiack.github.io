...
Alphafold impact ‘Science at Digital Speed’:

Alphafold has been freely available for 18 months  and according to DeepMind 1M+ researchers have now made use of it in their vital work. From antibiotic resistance to crop sustainability, you can read some of the stories here:

https://unfolded.deepmind.com/#stories.
...
https://www.salesforceairesearch.com/projects/ProGen
...
Story: https://t.co/OHFI70khhx

We’ve seen recently other major BioTech companies going into partnership with the AI/ML industry and academics:

NVIDIA Announces Partnership with GSK’s AI-Powered Lab for Discovery of Medicines and Vaccines

https://nvidianews.nvidia.com/news/nvidia-announces-partnership-with-gsks-ai-powered-lab-for-discovery-of-medicines-and-vaccines

GSK announces expanded collaboration with Tempus in precision medicine to accelerate R&D

https://www.gsk.com/en-gb/media/press-releases/gsk-announces-expanded-collaboration-with-tempus-in-precision-medicine-to-accelerate-rd/

Sanofi signs latest billion-dollar AI drug discovery deal

https://venturebeat.com/ai/sanofi-signs-latest-billion-dollar-ai-drug-discovery-deal-this-time-with-insilico/

Generative AI

ChatGPT has definitely made a slash, it is ushering in a new era of creativity and awareness around the capabilities of AI. By making AI and language models more accessible to people everywhere, from Uber drivers to high school students, ChatGPT is giving people the tools to unlock their imaginations and create new and innovative applications.
...
Researchers release AudioLDM, a Text-to-Audio Generation with Latent Diffusion Models. 

abs: https://arxiv.org/abs/2301.12503 

project page: https://audioldm.github.io

CVPR to include AI art demos

CVPR's Demos session is broadening to include an "Art Gallery" for AI-powered or generative media (diffusion, NeRF, AR, anything)

https://cvpr2023.thecvf.com/Conferences/2023/CallForDemos
...
Definitely a case to watch as this will be unchartered territory for copyright litigation and the outcome will have an impact on both research and the industry. 

https://t.co/DXuns6maGs
...
Early in 2023, Intercom annouced its integration of ChatGPT for summarisation and generative features such as expanding text and rephrasing customer answers. 
